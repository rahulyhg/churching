 ...
 *
 * @method     ChildCalendarEventQuery orderByGroupId($order = Criteria::ASC) Order by the calendar_id column
 * @method     ChildCalendarEventQuery orderByEventId($order = Criteria::ASC) Order by the event_id column
 *
 * @method     ChildCalendarEventQuery groupByGroupId() Group by the calendar_id column
 ...
 *
 * @method     ChildCalendarEvent findOneByGroupId(int $calendar_id) Return the first ChildCalendarEvent filtered by the calendar_id column
 ...
 *
 * @method     ChildCalendarEvent requireOneByGroupId(int $calendar_id) Return the first ChildCalendarEvent filtered by the calendar_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCalendarEvent[]|ObjectCollection findByGroupId(int $calendar_id) Return ChildCalendarEvent objects filtered by the calendar_id column
...
abstract class CalendarEventQuery extends ModelCriteria
{
     ...
     * Example usage:
     * <code>
     * $query->filterByGroupId(1234); // WHERE calendar_id = 1234
     * $query->filterByGroupId(array(12, 34)); // WHERE calendar_id IN (12, 34)
     * $query->filterByGroupId(array('min' => 12)); // WHERE calendar_id > 12
     * </code>
     *
    ...
    public function filterByGroupId($groupId = null, $comparison = null)
    {
        if (is_array($groupId)) {
            ...
            if (isset($groupId['min'])) {
                $this->addUsingAlias(CalendarEventTableMap::COL_CALENDAR_ID, $groupId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($groupId['max'])) {
                $this->addUsingAlias(CalendarEventTableMap::COL_CALENDAR_ID, $groupId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CalendarEventTableMap::COL_CALENDAR_ID, $groupId, $comparison);
    }
    ...
    {
        if ($calendarEvent) {
            $this->addCond('pruneCond0', $this->getAliasedColName(CalendarEventTableMap::COL_CALENDAR_ID), $calendarEvent->getGroupId(), Criteria::NOT_EQUAL);

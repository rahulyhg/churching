...
abstract class Person implements ActiveRecordInterface
{
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('per_firstname', new Length(array ('max' => 50,)));
        $metadata->addPropertyConstraint('per_lastname', new NotNull());
        $metadata->addPropertyConstraint('per_lastname', new Length(array ('max' => 50,)));
        $metadata->addPropertyConstraint('per_email', new NotNull());
        $metadata->addPropertyConstraint('per_email', new Email());
    }
